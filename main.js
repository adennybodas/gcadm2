...
auth: state,
browser: ['ADENNY BODAS 2 ','Safari','9.7.0']
}
...
async function connectionUpdate(update) {
  ...
  if (connection == 'open') { console.log(chalk.yellow('Made by ADENNY BODAS ')) }
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.welcome = '*HALLO SELAMAT DATANG* @user\n\n SELAMAT BERGABUNG, SEMOGA ANDA PUNYA KESAN YG BAIK DAN ISTIMEWA SERTA BAHAGIA BERSAMA KAMI & BETAH DI GROUP INI  @subject  SALAM KENAL DARI SEMUA ADMIN DAN MEMBER GRUP.. ' 
  conn.bye = 'SAYONARA ... WARGA KITA YANG INI  *@user MAU BELI SEMUR JENGKOL..... BARANGKALI ADA YG MAU NITIP '
...
setInterval(async () => {
  ...
  let bio = `🤖 Bot Aktif : ${uptime} ┃ 👑 BY ADENNY BODAS ┃ 🔗 IG ADENNY BODAS`
